...
namespace Up4All.Framework.MessageBus.Kafka.Consumers
{
    public class KafkaMQDefaultConsumer(IMessageBusAsyncConsumer consumer, IMessageBusMessageHandler handler)
