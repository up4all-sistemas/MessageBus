...
using Up4All.Framework.MessageBus.TransferHelper.Extensions;
...
namespace Up4All.Framework.MessageBus.TransferHelper
{
        ...
        where TOptionsDest : MessageBusOptions
    {
        ...
        public async Task OnMessageReceivedAsync(string entityPath, ReceivedMessage message, CancellationToken cancellationToken)
        {
            ...
            var destMessage = await _transformHandler.TransformAsync(message, _transformationsOptions, cancellationToken);
